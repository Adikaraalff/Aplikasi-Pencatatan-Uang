                            ...
                            <div class="card shadow-lg">
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="numbers">
                                                <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Uang</p>
                                            ...
                                            <div class="col-8">
                                                <div class="numbers">
                                                    ...
                                                    @php
                                                        ...
                                                        $totalKeluar = 0;
                                                    @endphp
                                                    @foreach ($dataUangMasuk as $dum)
                                                        @if ($dum->Lokasi_Uang->nama == $lu->nama)
                                                            @php
                                                                $totalJumlah += $dum->jumlah;
                                                            @endphp
                                                        @endif
                                                    @endforeach

                                                    @foreach ($dataUangKeluar as $duk)
                                                        @if ($duk->Lokasi_Uang->nama == $lu->nama)
                                                            @php
                                                                $totalKeluar += $duk->jumlah;
                                                            @endphp
                                                        @endif
                                                    @endforeach
                                                    <h5 class="font-weight-bolder">
                                                        {{ $totalJumlah + $totalKeluar }}
                                                    </h5>
                                                </div>
                                            </div>
                                            <div class="col-4 text-end">
                ...
                <div class="col-md-8">
                    <div class="card shadow-lg">
                        <div class="card-header bg-primary text-white">
                            <h1 class="text-center">{{ __('Welcome to Your Dashboard') }}</h1>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
